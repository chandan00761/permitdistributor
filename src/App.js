    ...
    return (
        <div>
          <div className="topElement">
            <AddPermit onAddClick={this.addPermit} depot={this.state.depot} transporters={this.state.transporter}/>
            <Summery depot={this.state.depot} trasporters={this.state.transporter.map(item => { return ([item.abbr,item.invoice.length, item.id])})}/>
          </div>
          <div className="resultSetContainer">
